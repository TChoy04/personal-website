  ...
  return (
    <div className='modal'>
        ...
        <div className="modal-body">
            <p>You get to play as Bartholomew, The Happy Snake! The consumption of the love is the only thing that makes him happy. The happier Bartholomew is, the longer he gets!</p>
            <br></br>
